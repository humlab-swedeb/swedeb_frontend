  ...
  >
    <div>
      <div class="row q-py-md justify-between">
        ...
        <!-- TODO: Implement download functionality with GET /speeches/download/{ticket_id} endpoint
        <q-btn-dropdown
          no-caps
          icon="download"
...
// TODO: Implement download functionality once GET /speeches/download/{ticket_id} endpoint is added
